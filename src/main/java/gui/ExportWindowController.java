...
public class ExportWindowController  implements ILoader, IProgress {
    ...
    private void exportFile()
    {
        ...
        _main.get_progressWindowController()._labelHeader.setText("Export LDIF in File->" + selectedFile.getAbsolutePath());
    ...
    public void setProgress(double progress, String description) {
        Platform.runLater(()-> {
            _main.get_progressWindowController().setProgress(progress,description);
        });
    }
