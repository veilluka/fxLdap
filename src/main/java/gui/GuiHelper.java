...
public class GuiHelper {
    ...
    public static File selectFile(Main main, FileChooser.ExtensionFilter extensionFilter , String title, FILE_OPTIONS file_options)
    {
        ...
        if(file_options.equals(FILE_OPTIONS.OPEN_DIRECTORY))
        {
            ...
            File defaultDirectory = new File(main.get_configuration().get_lastUsedDirectory());
        ...
        else if(file_options.equals(FILE_OPTIONS.SAVE_AS) || file_options.equals(FILE_OPTIONS.OPEN_FILE))
        {
            ...
            fileChooser.setInitialDirectory(new File(main.get_configuration().get_lastUsedDirectory()));
        ...
        {
            if(file_options.equals(FILE_OPTIONS.OPEN_DIRECTORY))   main.get_configuration().set_lastUsedDirectory(selectedFile.getAbsolutePath());
            else main.get_configuration().set_lastUsedDirectory(selectedFile.getParent());
