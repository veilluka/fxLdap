...
public class Icons {
    ...
    public Node getObjectType(Set<String> objectClass) {
        if (objectClass.contains("person"))
            return new ImageView(new Image(_iconInstance.getClass().getResourceAsStream("/icons/objectclass/person.png")));
        if (objectClass.contains("organization"))
            return new ImageView(new Image(_iconInstance.getClass().getResourceAsStream("/icons/objectclass/organisation.png")));
        if (objectClass.contains("groupofuniquenames") || objectClass.contains("group"))
            return new ImageView(new Image(_iconInstance.getClass().getResourceAsStream("/icons/objectclass/group.png")));
        if (objectClass.contains("organizationalunit"))
            return new ImageView(new Image(_iconInstance.getClass().getResourceAsStream("/icons/objectclass/orgUnit.png")));
        if (objectClass.contains("country"))
            return new ImageView(new Image(_iconInstance.getClass().getResourceAsStream("/icons/objectclass/country.png")));
        if (objectClass.contains("locality"))
            return new ImageView(new Image(_iconInstance.getClass().getResourceAsStream("/icons/objectclass/address.png")));
        return new ImageView(new Image(_iconInstance.getClass().getResourceAsStream("/icons/objectclass/top.png")));
    }

    public Node getIcon(ICON_NAME icon) {
        return new ImageView(new Image(_iconInstance.getClass().getResourceAsStream("/icons/" + ICONS_STRING_MAP.get(icon))));
    }
}
